...
// This file contains reusable SVG icon components to eliminate duplication across the application

export const PlusIcon = ({ className = "w-5 h-5 mr-2" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const CompletedTaskIcon = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
